...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [8] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO, KC_GRV, KC_NO, KC_LBRC, KC_LCBR, KC_RCBR, KC_RBRC, KC_AMPR, KC_LPRN, KC_RPRN, KC_EXLM, KC_ASTR, KC_NO, KC_NO, KC_HASH, KC_AT, KC_QUES, KC_SLSH, KC_NUBS, KC_PIPE, KC_DOT, KC_EQL, KC_COLN, KC_PLUS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
};
