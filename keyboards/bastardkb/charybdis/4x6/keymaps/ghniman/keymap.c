...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, TG(1), LT(6,KC_BSPC), KC_QUOT, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, LT(6,KC_F23), LT(5,KC_ESC), LCTL_T(KC_A), LSFT_T(KC_O), LALT_T(KC_E), KC_U, LGUI_T(KC_I), RGUI_T(KC_D), KC_H, RALT_T(KC_T), RSFT_T(KC_N), RCTL_T(KC_S), KC_MINS, LT(7,KC_DEL), LT(4,KC_SCLN), KC_Q, KC_J, KC_K, C_S_T(KC_X), KC_B, KC_M, KC_W, KC_V, LT(4,KC_Z), LT(7,KC_F24), LT(4,KC_SLSH), LSFT_T(KC_SPC), LT(8,KC_ENT), RSFT_T(KC_BSPC), LT(8,KC_SPC), KC_NUBS, LT(6,KC_NO), LT(6,KC_ENT)),
    ...
    [8] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO, KC_GRV, LCTL_T(KC_QUOT), LSFT_T(KC_LBRC), KC_LCBR, KC_RCBR, KC_RBRC, KC_AMPR, KC_LPRN, KC_RPRN, RSFT_T(KC_COMM), RCTL_T(KC_DOT), KC_NO, KC_NO, KC_HASH, KC_AT, KC_QUES, KC_SLSH, KC_BSLS, KC_PIPE, KC_EXLM, KC_EQL, KC_COLN, KC_ASTR, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
};
