...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT(KC_NO, KC_ACL0, KC_ACL1, KC_ACL2, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN3, KC_BTN2, KC_BTN1, KC_NO, KC_NO, KC_BTN1, KC_BTN2, KC_BTN4, KC_BTN5, KC_NO, KC_NO, KC_TRNS, DRGSCRL, SNIPING, KC_NO, KC_NO, KC_NO, KC_BTN3, SNIPING, DRGSCRL, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	...
	[8] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_CIRC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_DLR, KC_NO, KC_COMM, KC_LBRC, KC_LCBR, KC_RCBR, KC_RBRC, KC_AMPR, KC_LPRN, KC_RPRN, KC_EXLM, KC_DOT, KC_PERC, KC_NO, KC_HASH, KC_AT, KC_QUES, KC_SLSH, KC_BSLS, KC_PIPE, KC_ASTR, KC_EQL, KC_COLN, KC_PLUS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
};
